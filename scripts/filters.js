class Filters extends React.Component {
  ...
  handleSelectPrice = (e) => {
    this.props.selectPrice(e.target.value);
  };
  handleSelectRooms = (e) => {
    this.props.selectRooms(e.target.value);
  };
  ...
  render() {
    return (
      <div>
        ...
        <select id="country" name="country" onChange={this.handleSelectCountry}>
        ...
        <select id="price" name="price" onChange={this.handleSelectPrice}>
        ...
        <select id="room" name="room" onChange={this.handleSelectRooms}>
